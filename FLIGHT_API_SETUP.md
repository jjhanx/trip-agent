...
여행 정보에 **마일리지 프로그램**을 입력하면, 해당 마일리지가 적립되는 항공사 편을 **우선 상단**에 표시합니다. 해당 항공사의 가능한 비행편은 모두 노출되며, 목록이 길면 스크롤로 확인할 수 있습니다.

지원 프로그램 예: Skypass(대한항공), Asiana(아시아나), Miles & More(루프트한자·스위스·오스트리아 항공 등)
