...
선택: Travelpayouts 대시보드에서 **Cars(렌트카)** 용 딥링크를 넣으면 목록 **하단**에 제휴 카드가 추가됩니다. 링크가 **economybookings.tpk.ro** 형태이면 세션이 EconomyBookings 비교·차급 카드 링크에 **btag·tpo_uid**를 병합합니다(검색당 제휴 URL 1회 요청). **항공 검색용 Aviasales 등 URL은 자동으로 제외**됩니다.
