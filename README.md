...
| 날짜 | 변경 내용 |
|------|-----------|
| 2026-04-16 | **숙소**: Google Places(Nearby lodging)·Place Details·Distance Matrix로 명소 좌표 기준 주행 분 합이 작은 후보(최대 5); mock 폴백; 명소 카탈로그 세션 전달; 렌트 시 숙소 단계 `local_transport` 빈 배열·주행 분은 카드에만. [docs/HOTEL_SEARCH_API.md](docs/HOTEL_SEARCH_API.md). `app.js?v=37`, `styles.css?v=14`. |
