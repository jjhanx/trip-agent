...
| 날짜 | 변경 내용 |
|------|-----------|
| 2026-04-02 | **명소 실무 정보 요건 강화**: LLM 프롬프트를 수정하여 명소 추천 시 가까운 대중교통 거점 동네와 명소 입구까지 차량 소요 시간, 케이블카/리프트 명확한 유무 파악, 정확한 주차 요금/입장료 및 운영 시간과 예약 제한 여부를 명시하도록 개선 (`agents/itinerary/executor.py`, `shared/google_place_details.py`). |
