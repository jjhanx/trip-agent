...
### 6.2.2 일정 명소 이미지 (위키·Commons·선택 SerpApi)
...
| 날짜 | 변경 내용 |
|------|-----------|
| 2026-03-23 | **명소 이미지**: **위키백과(영·이) 썸네일 + Wikimedia Commons** API로 실제 장소 사진 우선, 실패 시 Unsplash·선택 `PLACE_IMAGES_USE_SERPAPI`+`SERPAPI_API_KEY`로 Google 이미지 검색. `shared/place_images.py` · [docs/IMAGES_AND_LICENSES.md](docs/IMAGES_AND_LICENSES.md) |
