...
| 날짜 | 변경 내용 |
|------|-----------|
| 2026-04-02 | **명소 실무**: Places 보강은 **「확인하십시오」 제거**·사실·URL만; **등록 주소는 예약·링크 블록에 한 번만**, `parking`은 **거점 도시·차로 ○분** 중심; 주차 **인구 3천·○분** 검증·재폴리시; Tre Cime **중복 병합**; 사진 Details·Commons (`shared/google_place_details.py`, `agents/itinerary/executor.py`, `shared/place_images.py`). |
