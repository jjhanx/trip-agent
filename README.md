...
**순서**: SerpApi → Amadeus(429 시) → Travelpayouts(캐시 최저가 참고) → Mock. 상세·렌트카 제휴 URL은 [FLIGHT_API_SETUP.md](FLIGHT_API_SETUP.md), [docs/TRAVELPAYOUTS_API_GUIDE.md](docs/TRAVELPAYOUTS_API_GUIDE.md) 참조.
