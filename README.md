...
| 변수 | 설명 |
|------|------|
| AMADEUS_CLIENT_ID | [Amadeus](https://developers.amadeus.com) Client ID (월 2,000회 무료) |
| AMADEUS_CLIENT_SECRET | Amadeus Client Secret |
| KIWI_API_KEY | [Kiwi Tequila](https://tequila.kiwi.com) API Key (분당 100회 무료) |
| RAPIDAPI_KEY | [RapidAPI Skyscanner](https://rapidapi.com/skyscanner/api/skyscanner-flight-search) Key (Basic 무료) |

설정 시 Amadeus + Kiwi + RapidAPI를 병렬 호출해 최저가 비교. 무료 한도 초과 전 자동 중단·경고 표시. 미설정 시 Mock 데이터 사용.
