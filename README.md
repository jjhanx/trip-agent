...
| 날짜 | 변경 내용 |
|------|-----------|
| 2026-04-02 | **Grand Circle 명소 품질**: Places 수집에서 **앵커 4000km** 한도로 시카고 **Skydeck** 등 중서부 도심 전망대가 섞이던 문제를 **서남부 경계 박스·주소·이름 필터**·**Nearby `observation deck` 제외**로 차단. **Moab** 지오코드 시드·텍스트 검색 **Arches 우선**·큐레이션에서 **아치스 국립공원을 자이언 직후**로 올려 누락 완화(`agents/itinerary/executor.py`). |
